...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 17 oct. 2018 à 17:12
...
--
-- Base de données :  `annuaire_film2`
--
...
CREATE TABLE IF NOT EXISTS `acteur` (
  `ActeurId` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `films` (
  `FilmsID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`FilmsID`),
  KEY `ESTCATEGORIE` (`Categorie`),
  KEY `ESTREALISATEUR` (`RealisateurID`),
  KEY `ESTACTEUR` (`ActeurId`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `realisateur` (
  `RealisateurID` int(11) NOT NULL AUTO_INCREMENT,
  `Nom` varchar(50) NOT NULL,
  `Prenom` varchar(35) NOT NULL,
  `Photo` varchar(50) NOT NULL,
